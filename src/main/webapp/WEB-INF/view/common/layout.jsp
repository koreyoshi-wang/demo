...
<head>
  ...
  <!-- AOH -->
  <script type="text/javascript" src="${contextPath}/js/AOH.js"></script>
...
<div class="wrapper">
  ...
  <jsp:include page="${header_path}"></jsp:include>
  <!-- =============================================== -->

  <!-- Left side column. contains the sidebar -->
  <jsp:include page="${siderbar_path}"></jsp:include>
  <!-- =============================================== -->

  <!-- Content Wrapper. Contains page content -->
  <jsp:include page="${content_path}"></jsp:include>
  <!-- =============================================== -->
  
  <!-- Footer Wrapper. Contains the footer -->
  <jsp:include page="${footer_path}"></jsp:include>
  <!-- =============================================== -->

  <!-- Help Wrapper. Contains the help -->
...
<!-- FastClick -->
<script type="text/javascript" src="${contextPath}/js/fastclick.min.js"></script>
<!-- AdminLTE App -->
<script type="text/javascript" src="${contextPath}/js/app.min.js"></script>
<!-- AdminLTE App -->
